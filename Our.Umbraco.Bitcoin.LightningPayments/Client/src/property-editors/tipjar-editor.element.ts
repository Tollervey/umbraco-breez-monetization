...
@customElement('our-tipjar-editor')
export class OurTipJarEditorElement extends LitElement {
...
declare global {
 interface HTMLElementTagNameMap { 'our-tipjar-editor': OurTipJarEditorElement; }
}