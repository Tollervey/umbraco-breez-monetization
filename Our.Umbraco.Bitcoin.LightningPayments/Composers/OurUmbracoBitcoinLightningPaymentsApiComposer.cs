...
{
    public class OurUmbracoBitcoinLightningPaymentsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Our Umbraco Bitcoin Lightning Payments Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<OurUmbracoBitcoinLightningPaymentsOperationSecurityFilter>();
            });
        }

        public class OurUmbracoBitcoinLightningPaymentsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Our.Umbraco.Bitcoin.LightningPayments.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
