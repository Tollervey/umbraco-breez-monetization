...
namespace umbraco_breez_monetization.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "umbraco_breez_monetization")]
    public class umbracobreezmonetizationApiController : umbracobreezmonetizationApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public umbracobreezmonetizationApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
