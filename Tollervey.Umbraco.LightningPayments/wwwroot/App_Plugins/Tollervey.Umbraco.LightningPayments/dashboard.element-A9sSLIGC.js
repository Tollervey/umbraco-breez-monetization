import { LitElement as se, html as q, css as ae, state as N, customElement as ue } from "@umbraco-cms/backoffice/external/lit";
...
function x() {
  ...
  return F.getSymbolSize = function(r) {
    ...
    return r * 4 + 17;
  }, F.getSymbolTotalCodewords = function(r) {
    return n[r];
  }, F.getBCHDigit = function(o) {
    let r = 0;
    for (; o !== 0; )
      r++, o >>>= 1;
    return r;
  }, F.setToSJISFunction = function(r) {
  ...
  return Lt || (Lt = 1, (function(t) {
    ...
    t.isValid = function(e) {
      ...
      for (let v = 0; v < i; v++) {
        ...
        for (let g = 0; g < i; g++) {
          let c = e.get(v, g);
          c === l ? u++ : (u >= 5 && (s += n.N1 + (u - 5)), l = c, u = 1), c = e.get(g, v), c === h ? a++ : (a >= 5 && (s += n.N1 + (a - 5)), h = c, a = 1);
        }
...
function ee() {
  ...
  $.KANJI = new RegExp(o, "g"), $.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), $.BYTE = new RegExp(r, "g"), $.NUMERIC = new RegExp(t, "g"), $.ALPHANUMERIC = new RegExp(n, "g");
  const e = new RegExp("^" + o + "$"), i = new RegExp("^" + t + "$"), s = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
  return $.testKanji = function(a) {
    return e.test(a);
  }, $.testNumeric = function(a) {
    return i.test(a);
  }, $.testAlphanumeric = function(a) {
    return s.test(a);
  }, $;
}
var Ft;
...
function be() {
  return xt || (xt = 1, (function(t) {
    const n = x(), o = Xt(), r = Et(), e = H(), i = te(), s = 7973, u = n.getBCHDigit(s);
    function a(g, c, B) {
      for (let T = 1; T <= 40; T++)
    ...
    t.from = function(c, B) {
      ...
      typeof T > "u" && (T = e.BYTE);
      const L = n.getSymbolTotalCodewords(c), A = o.getTotalCodewordsCount(c, B), I = (L - A) * 8;
...
function ve() {
  if (Ht) return dt;
  Ht = 1;
  const t = x(), n = 1335, o = 21522, r = t.getBCHDigit(n);
  ...
  return jt || (jt = 1, (function(t) {
    var n = {
      single_source_shortest_paths: function(o, r, e) {
        ...
        u.push(r, 0);
        for (var a, l, h, v, g, c, B, T, L; !u.empty(); ) {
          a = u.pop(), l = a.value, v = a.cost, g = o[l] || {};
          for (h in g)
            g.hasOwnProperty(h) && (c = g[h], B = v + c, T = s[h], L = typeof s[h] > "u", (L || T > B) && (s[h] = B, u.push(h, B), i[h] = l));
        }
...
function Be() {
  return Jt || (Jt = 1, (function(t) {
    const n = H(), o = Ee(), r = Ce(), e = Ae(), i = Re(), s = ee(), u = x(), a = Se();
    function l(A) {
    ...
    function v(A) {
      ...
      let E, k;
      return u.isKanjiModeEnabled() ? (E = h(s.BYTE, n.BYTE, A), k = h(s.KANJI, n.KANJI, A)) : (E = h(s.BYTE_KANJI, n.BYTE, A), k = []), I.concat(R, E, k).sort(function(w, y) {
    ...
    function c(A) {
      return A.reduce(function(I, R) {
        const E = I.length - 1 >= 0 ? I[I.length - 1] : null;
        return E && E.mode === R.mode ? (I[I.length - 1].data += R.data, I) : (I.push(R), I);
      }, []);
    }
    function B(A) {
      const I = [];
      for (let R = 0; R < A.length; R++) {
        ...
        switch (E.mode) {
          case n.NUMERIC:
            I.push([
              E,
              { data: E.data, mode: n.ALPHANUMERIC, length: E.length },
              { data: E.data, mode: n.BYTE, length: E.length }
            ]);
            break;
          case n.ALPHANUMERIC:
            I.push([
          ...
          case n.KANJI:
            I.push([
              E,
              { data: E.data, mode: n.BYTE, length: l(E.data) }
            ]);
            break;
          case n.BYTE:
            I.push([
    ...
    function T(A, I) {
      ...
      for (let f = 0; f < A.length; f++) {
        ...
        for (let d = 0; d < w.length; d++) {
          const C = w[d], m = "" + f + d;
          y.push(m), R[m] = { node: C, lastCount: 0 }, E[m] = {};
          for (let b = 0; b < k.length; b++) {
            const p = k[b];
            R[p] && R[p].node.mode === C.mode ? (E[p][m] = g(R[p].lastCount + C.length, C.mode) - g(R[p].lastCount, C.mode), R[p].lastCount += C.length) : (R[p] && (R[p].lastCount = C.length), E[p][m] = g(C.length, C.mode) + 4 + n.getCharCountIndicator(C.mode, I));
          }
        }
        k = y;
      }
    ...
    function L(A, I) {
      let R;
      const E = n.getBestModeForData(A);
      if (R = n.from(I, E), R !== n.BYTE && R.bit < E.bit)
        throw new Error('"' + A + '" cannot be encoded with mode ' + n.toString(R) + `.
 Suggested mode is: ` + n.toString(E));
    ...
    t.fromArray = function(I) {
      return I.reduce(function(R, E) {
        return typeof E == "string" ? R.push(L(E, null)) : E.data && R.push(L(E.data, E.mode)), R;
      }, []);
    }, t.fromString = function(I, R) {
      const E = v(I, u.isKanjiModeEnabled()), k = B(E), f = T(k, R), w = a.find_path(f.map, "start", "end"), y = [];
      for (let d = 1; d < w.length - 1; d++)
        y.push(f.table[w[d]].node);
      return t.fromArray(c(y));
    }, t.rawSplit = function(I) {
      return t.fromArray(
        v(I, u.isKanjiModeEnabled())
      );
    };
  })(ht)), ht;
}
...
function Te() {
  if (Qt) return X;
  Qt = 1;
  const t = x(), n = Et(), o = de(), r = he(), e = fe(), i = ge(), s = me(), u = Xt(), a = we(), l = be(), h = ve(), v = H(), g = Be();
  function c(f, w) {
      ...
      for (p === 6 && p--; ; ) {
        for (let S = 0; S < 2; S++)
          if (!f.isReserved(C, p - S)) {
            let _ = !1;
            b < w.length && (_ = (w[b] >>> m & 1) === 1), f.set(C, p - S, _), m--, m === -1 && (b++, m = 7);
          }
        if (C += d, C < 0 || y <= C) {
          C -= d, d = -d;
          break;
  ...
  function R(f, w, y) {
    ...
    y.forEach(function(S) {
      d.put(S.mode.bit, 4), d.put(S.getLength(), v.getCharCountIndicator(S.mode, f)), S.write(d);
    });
  ...
  function E(f, w, y) {
    const d = t.getSymbolTotalCodewords(w), C = u.getTotalCodewordsCount(w, y), m = d - C, b = u.getBlocksCount(w, y), p = d % b, S = b - p, _ = Math.floor(d / b), V = Math.floor(m / b), re = V + 1, Ct = _ - V, ie = new a(Ct);
    let Q = 0;
  ...
  function k(f, w, y, d) {
    ...
    if (Array.isArray(f))
      ...
      if (!_) {
        ...
        _ = l.getBestVersionForData(V, y);
      }
      C = g.fromString(f, _ || 40);
    } else
...
`
    ...
    return c(S, w), B(S), T(S, w), A(S, y, 0), w >= 7 && L(S, w), I(S, b), isNaN(d) && (d = s.getBestMask(
      S,
      A.bind(null, S, y)
...
function ne() {
  return Yt || (Yt = 1, (function(t) {
    ...
    t.getOptions = function(r) {
      ...
      const s = e.modules.size, u = e.modules.data, a = t.getScale(s, i), l = Math.floor((s + i.margin * 2) * a), h = i.margin * a, v = [i.color.light, i.color.dark];
      for (let g = 0; g < l; g++)
        for (let c = 0; c < l; c++) {
          let B = (g * l + c) * 4, T = i.color.light;
          if (g >= h && c >= h && g < l - h && c < l - h) {
            const L = Math.floor((g - h) / a), A = Math.floor((c - h) / a);
            T = v[u[L * s + A] ? 1 : 0];
          }
...
function Ie() {
  return Gt || (Gt = 1, (function(t) {
    ...
    t.render = function(i, s, u) {
      ...
      const h = n.getImageWidth(i.modules.size, a), v = l.getContext("2d"), g = v.createImageData(h, h);
      return n.qrToImageData(g.data, i, a), o(v, l, h), v.putImageData(g, 0, 0), l;
    }, t.renderToDataURL = function(i, s, u) {
      let a = u;
      typeof a > "u" && (!s || !s.getContext) && (a = s, s = void 0), a || (a = {});
      const l = t.render(i, s, a), h = a.type || "image/png", v = a.rendererOpts || {};
      return l.toDataURL(h, v.quality);
    };
  })(wt)), wt;
}
var vt = {}, Wt;
function Pe() {
  ...
  function r(e, i, s) {
    ...
    for (let v = 0; v < e.length; v++) {
      const g = Math.floor(v % i), c = Math.floor(v / i);
      !g && !l && (l = !0), e[v] ? (h++, v > 0 && g > 0 && e[v - 1] || (u += l ? o("M", g + s, 0.5 + c + s) : o("m", a, 0), a = 0, l = !1), g + 1 < i && e[v + 1] || (u += o("h", h), h = 0)) : a++;
    }
    return u;
  }
  return vt.render = function(i, s, u) {
    const a = t.getOptions(s), l = i.modules.size, h = i.modules.data, v = l + a.margin * 2, g = a.color.light.a ? "<path " + n(a.color.light, "fill") + ' d="M0 0h' + v + "v" + v + 'H0z"/>' : "", c = "<path " + n(a.color.dark, "stroke") + ' d="' + r(h, l, a.margin) + '"/>', B = 'viewBox="0 0 ' + v + " " + v + '"', L = '<svg xmlns="http://www.w3.org/2000/svg" ' + (a.width ? 'width="' + a.width + '" height="' + a.width + '" ' : "") + B + ' shape-rendering="crispEdges">' + g + c + `</svg>
`;
    return typeof u == "function" && u(null, L), L;
  }, vt;
}
var Zt;
function Me() {
  ...
  function e(i, s, u, a, l) {
    const h = [].slice.call(arguments, 1), v = h.length, g = typeof h[v - 1] == "function";
    if (!g && !t())
      throw new Error("Callback required as last argument");
    if (g) {
      if (v < 2)
        throw new Error("Too few arguments provided");
      v === 2 ? (l = u, u = s, s = a = void 0) : v === 3 && (s.getContext && typeof l > "u" ? (l = a, a = void 0) : (l = a, a = u, u = s, s = void 0));
    } else {
      if (v < 1)
        throw new Error("Too few arguments provided");
      return v === 1 ? (u = s, s = a = void 0) : v === 2 && !s.getContext && (a = u, u = s, s = void 0), new Promise(function(c, B) {
        try {
...
let P = class extends le(se) {
  ...
  connectedCallback() {
    super.connectedCallback(), this.autoRefresh && this.startAutoRefresh(), this.connectRealtime();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.stopAutoRefresh(), this._evtSrc?.close(), this._evtSrc = void 0;
  }
  connectRealtime() {
    try {
      this._evtSrc?.close(), this._evtSrc = new EventSource("/api/public/lightning/realtime/subscribe"), this._evtSrc.addEventListener("payment-succeeded", async () => {
        await this.loadPayments();
      }), this._evtSrc.addEventListener("breez-event", (t) => {
        try {
          const n = JSON.parse(t.data), o = {
            time: (/* @__PURE__ */ new Date()).toLocaleTimeString(),
            type: String(n?.type ?? "Unknown"),
            details: String(n?.details ?? "")
          }, r = 50;
          this.eventLog = [o, ...this.eventLog].slice(0, r);
        } catch {
        }
  ...
  renderStatus() {
    return q`
      <uui-box headline="Status" style="margin-bottom: var(--uui-size-layout-1)">
        ...
        ${this.loadingStatus ? q`<div>Loading status�</div>` : this.errorStatus ? q`<uui-alert color="danger">${this.errorStatus}</uui-alert>` : q`
          ...
          ${this.recommendedFees ? q`<details class="fees-details"><summary>Recommended on-chain fees</summary><pre>${JSON.stringify(this.recommendedFees, null, 2)}</pre></details>` : ""}
        `}
      </uui-box>`;
  }
  renderQuote() {
    return q`
      <uui-box headline="Receive fee quote" style="margin-bottom: var(--uui-size-layout-1)">
        ...
        ${this.quoteError ? q`<uui-alert color="danger">${this.quoteError}</uui-alert>` : ""}
        ${this.quoteResult ? q`<div class="quote-out">Estimated fees: <strong>${this.quoteResult.feesSat}</strong> sats (${this.quoteResult.method})</div>` : ""}
      </uui-box>`;
  }
  renderTestTools() {
    ...
    return q`
      <uui-box headline="Test invoice" style="margin-bottom: var(--uui-size-layout-1)">
        ...
        ${this.invoiceError ? q`<uui-alert color="danger">${this.invoiceError}</uui-alert>` : ""}
        ...
        ${this.createdInvoice ? q`
              <div class="invoice-out">
                ${this.invoiceQrDataUrl ? q`<img class="qr" src="${this.invoiceQrDataUrl}" alt="Invoice QR" />` : ""}
                <div class="invoice-text">
                  ...
                  <div class="actions">
                    ...
                    ${t ? q`<a class="open-wallet" href="${t}">Open in wallet</a>` : ""}
                  </div>
  ...
  renderEventLog() {
    return q`
      <uui-box headline="Live events">
        <ul class="event-log">
          ${this.eventLog.map((t) => q`<li><span class="t">${t.time}</span> <strong>${t.type}</strong> <span class="d">${t.details}</span></li>`)}
        </ul>
      </uui-box>
    `;
  }
...
//# sourceMappingURL=dashboard.element-A9sSLIGC.js.map
