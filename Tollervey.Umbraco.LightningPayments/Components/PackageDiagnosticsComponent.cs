...
public class PackageDiagnosticsComponent : IComponent
{
    ...
    private void AnalyzeBundle(IFileProvider fp, string basePath)
    {
        ...
        bool mentionsSectionAlias = bundleHead.Contains("Tollervey.LightningPayments.Section");
        ...
        {
            _logger.LogInformation("Bundle analysis: Dashboard appears to target custom section alias 'Tollervey.LightningPayments.Section'.");
        }
