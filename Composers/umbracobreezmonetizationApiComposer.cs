...
namespace umbraco_breez_monetization.Composers
{
    public class umbracobreezmonetizationApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "umbracobreezmonetizationBackoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<umbracobreezmonetizationOperationSecurityFilter>();
            });
        }

        public class umbracobreezmonetizationOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("umbraco_breez_monetization.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
